...
export default function Categories(){
  ...
  return <div>
    ...
    <NormaNormalCenteredTextlText><BoldNormalText>Step 3:</BoldNormalText>Check our rules below to review our list of accepted and non-accepted items</NormalCenteredText>
